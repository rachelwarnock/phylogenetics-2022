...
#TODO: add a ref to dos Reis for the mx bound
```
...
knitr::include_graphics("trace3.png")
```
...
```{r, echo=FALSE, out.width="85%",  out.extra='style="padding:10px"'}
knitr::include_graphics("trace4.png")
```
...
A complete set of scripts for this exercise can be downloaded [here](scripts/exercise05-scripts.zip).