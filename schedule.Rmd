...
4. Bayesian inference and MCMC II, intro to clock models 07.04
5. The fossilised birth-death process 14.05
...
urls <- c("slides/04-clocks.pdf", "exercise-04.html")

dt <- data.frame(schedule = c("Slides", "Exercise 4"),
                 topics = c("Recap Bayesian inference and molecular dating", 
