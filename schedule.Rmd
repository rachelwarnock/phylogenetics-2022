...
dt <- data.frame(schedule = c("Slides", "Exercise 2"),
                 topics = c("statistical consistency, graphical models", 
...
* Reading [Maximum likelihood and Bayesian inference](https://paleo.domains.swarthmore.edu/Publications/quantpaleo2010.pdf) by Steve Wang
