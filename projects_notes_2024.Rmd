...
* Status update: initial analysis looks good but didn't converge, 
* Going to try FBD skyline, i.e., rate variation through time
...
* Next step: use model adequacy to compare different models
...
* Status update: age data data obtained. FBD set up in progress!
