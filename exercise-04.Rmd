...
For this exercise you can create a folder called `exercise 4` or something. The create two sub-directories, `data` for your nexus file and another `scripts` for your code. For this tutorial we'll create at least three scripts:
